...
export function LocationIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 16 16" className={className} fill="currentColor" aria-hidden="true">
      <path d="M8 0a5.53 5.53 0 00-5.5 5.5c0 3.813 5.5 10.5 5.5 10.5S13.5 9.313 13.5 5.5A5.53 5.53 0 008 0zm0 8a2.5 2.5 0 110-5 2.5 2.5 0 010 5z" />
    </svg>
  );
}
...
export function ArrowUpIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 16 16" className={className} fill="currentColor" aria-hidden="true">
      <path d="M3.47 7.78a.75.75 0 010-1.06l4.25-4.25a.75.75 0 011.06 0l4.25 4.25a.75.75 0 01-1.06 1.06L8.75 4.56v8.19a.75.75 0 01-1.5 0V4.56L4.53 7.78a.75.75 0 01-1.06 0z" />
    </svg>
  );
}
